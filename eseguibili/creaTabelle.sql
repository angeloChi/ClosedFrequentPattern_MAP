...
CREATE DATABASE CFP17_621498;




GRANT CREATE, SELECT, INSERT, DELETE ON CFP17_621498.* TO Angeletti_621498@localhost IDENTIFIED BY 'CFP17_621498';

USE CFP17_621498;


create table iris(
SepalLength float (5,2),
SepalWidth float(5,2),
PetalLength float(5,2),
